defmodule Rumbl.MultimediaTest do
  ...
  describe "categories" do
    test "list_alphabetical_categories/1" do
  ...
  describe "videos" do
    ...
    test "get_video!/1 returns the video with given id" do owner = user_fixture()
    ...
    test "create_video/2 with invalid data returns error changeset" do owner = user_fixture()
      assert {:error, %Ecto.Changeset{}} =
      Multimedia.create_video(owner, @invalid_attrs)
    end

    test "update_video/2 with valid data updates the video" do owner = user_fixture()
    ...
    test "update_video/2 with invalid data returns error changeset" do owner = user_fixture()
